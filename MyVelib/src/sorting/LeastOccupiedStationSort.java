...
/**
 * This class describes the sorting algorithm that allows to retrieve the least occupied station.
 * It implements the built-in interface Comparator for our class StationBalance.
 */
public class LeastOccupiedStationSort implements Comparator<StationBalance>{
	 ...
	 * 
	 * @return integer: the difference of the occupation between two docking stations
	 */
	@Override
	public int compare(StationBalance o1, StationBalance o2) {
		// TODO Auto-generated method stub
		return (int) (o1.total_returns - o1.total_rents - (o2.total_returns - o2.total_rents));
	}
