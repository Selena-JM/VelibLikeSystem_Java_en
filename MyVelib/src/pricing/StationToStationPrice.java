...
/**
 * This class describes the pricing for a trip starting in a docking station and ending in a station (standard or plus).
 * It implements the interface PricingStrategy.
 */
public class StationToStationPrice implements PricingStategy{
	/**
	 ...
	 */
	public StationToStationPrice(Trip trip) {
		super();
		this.trip = trip;
	}
	
	/**
	 * Method to calculate the price for a trip from a station to another station.
	 * This applies the standard price for renting a bike.
	 * 
	 * @param trip the trip that is priced
	 * 
	...
	public ArrayList<Double> setPrice(Trip trip) {
		...
		System.out.println("Price from station to station : " + price);
